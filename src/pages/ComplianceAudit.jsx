      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ borderRadius: 3, border: '1px solid #d1d5db' }}>
            <CardContent>
              <Typography variant="subtitle2" sx={{ color: '#6b7280', mb: 1 }}>Documentation Rate</Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ borderRadius: 3, border: '1px solid #d1d5db' }}>
            <CardContent>
              <Typography variant="subtitle2" sx={{ color: '#6b7280', mb: 1 }}>Consent Rate</Typography>
              <Typography variant="h4" sx={{ fontWeight: 700, color: '#111827' }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ borderRadius: 3, border: '1px solid #d1d5db' }}>
            <CardContent>
              <Typography variant="subtitle2" sx={{ color: '#6b7280', mb: 1 }}>Last Audit</Typography>
              <Typography variant="body1" sx={{ fontWeight: 700, color: '#111827', fontSize: '14px' }}>
