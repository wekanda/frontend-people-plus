    ...
    <Paper sx={sectionStyles.paper}>
      ...
      {actionLabel ? (
        <Box sx={{ px: 2.5, pb: 2.5, pt: 0.75, display: 'flex', justifyContent: 'flex-end' }}>
          <Button
            variant="contained"
            sx={{ background: '#1d4ed8', textTransform: 'none', px: 2, py: 0.6, fontSize: '0.85rem', minHeight: 36 }}
                ...
                <TableContainer>
                  <Table>
                    <TableHead sx={{ backgroundColor: '#eff6ff' }}>
                      <TableRow>
                        <TableCell sx={{ fontWeight: 700, color: '#1e3a8a' }}>Employee</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: '#1e3a8a' }}>From</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: '#1e3a8a' }}>To</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: '#1e3a8a' }}>Date</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: '#1e3a8a' }}>Status</TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
