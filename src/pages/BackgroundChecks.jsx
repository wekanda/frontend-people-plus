  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <div style={{ marginBottom: 20, border: '1px solid #ccc', padding: 15 }}>
        ...
        <button onClick={startCheck} style={{ backgroundColor: '#4CAF50', color: 'white', padding: '10px 20px' }}>
          Start Check
        </button>
      </div>
            ...
            <tr key={c.id} style={{ borderBottom: '1px solid #ddd' }}>
              ...
              <td style={{ padding: 10 }}>
                <span style={{ 
                  padding: '5px 10px', 
                  borderRadius: 4,
                  backgroundColor: c.status === 'passed' ? '#4CAF50' : c.status === 'failed' ? '#f44336' : '#ff9800',
                  color: 'white'
                }}>
                  {c.status}
                </span>
